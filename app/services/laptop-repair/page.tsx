          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm opacity-80">
                Professional laptop repair services across Johannesburg with same-day turnaround and warranty guarantee.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm opacity-80">
                ...
                <li>
                  <Link href="/services/data-recovery" className="hover:text-primary transition-colors">
                    Data Recovery
                  </Link>
                </li>
              </ul>
